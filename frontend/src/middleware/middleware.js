...
function middleware(request) {
    return __awaiter(this, void 0, void 0, function () {
        var pathname, protectedRoutes, publicRoutes, isProtectedRoute, isPublicRoute, session, session;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!isProtectedRoute) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, auth_1.getServerSession)()];
                case 1:
                    session = _a.sent();
                    if (!session) {
                    ...
                    _a.label = 2;
                case 2:
                    if (!(isPublicRoute && pathname === '/login')) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, auth_1.getServerSession)()];
                case 3:
                    session = _a.sent();
                    if (session) {
                    ...
                    _a.label = 4;
                case 4: return [2 /*return*/, server_1.NextResponse.next()];
            }
        });
    });
}
